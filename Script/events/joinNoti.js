...
module.exports.run = async function({ api, event }) {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    api.sendMessage("চ্ঁলে্ঁ এ্ঁসে্ঁছি্ঁ Ovir boww এঁখঁনঁ তোঁমাঁদেঁরঁ সাঁথেঁ আঁড্ডাঁ দিঁবঁ..!", threadID, () => {
...
›› 𝐁𝐚𝐛𝐲 {name},  
   তুমি এই গ্রুপের {soThanhVien} নম্বর মেম্বার!

›› গ্রুপ: {threadName}

💌 🌺 𝐖 𝐄 𝐋 𝐂 𝐎 𝐌 𝐄 🌺 💌
╭─╼╾─╼🌸╾─╼╾───╮
  ─꯭─⃝‌‌𝐎𝐕𝐈𝐑 𝐁𝐎𝐖 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭 
╰───╼╾─╼🌸╾─╼╾─╯
